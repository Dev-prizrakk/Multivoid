...
| Doors, lights and devices | doors, light switches and light groups, keypads, power panels, the garage, cargo lift, appliances, locker lids, windows, grime, the wind turbine, containers and their contents, the delivery drone, shop orders, the coin gun and the shared balance | the host holds the state; a client sends an intent that the host performs |
